...
## BUT3A Infonum –<br />UE "Sciences humaines et sociales"
...
Jusqu'à "…convaincue qu'elle gérait des données de la recherche" (28'38).
...
Jusqu'à "… au risque de me le faire prendre, exploiter par d'autres avec qui je suis en compétition." (24'44)
...
## Ce sentiment de propriété pose des difficultés (1)
<br />
<br />
...
Jusqu'à "… il se trouve être en contradiction avec les réalités juridiques et institutionnelles." (38'15)

---
class: clear

## Ce sentiment de propriété pose des difficultés (2)
<br />
<br />

.center[
<iframe width="560" height="315" src="https://www.youtube.com/embed/o8acXD4s5iU?start=2665" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>]

???

Le sentiment de propriété augmente avec l'effort et l'investissement.

Jusqu'à "… un indice d'accroissement de ce sentiment de propriété." (45'10)
...
#### 1. Consultez cette offre d'emploi de l'Université Paris Nanterre : https://s.42l.fr/data-librarian
...
.center[
<img src="img/openworking.wordpress.com.jpeg" width="50%">]

Ce métier porte aussi le nom d'intendant de données (*data steward*) ou de *data curator*.
...
.footnote[Candice Fillaud (2020). *Ouverture des données de la recherche dans la communauté en Intelligence Artificielle : exemple du Plan de gestion des données ANITI*. Mémoire de M1 Information et Médiation Scientifique et Technique, Université Claude Bernard Lyon 1 https://memsic.ccsd.cnrs.fr/mem_04135399]
...
Ce sont les principes qu'on va suivre dans le PGD.
...
## Conséquences pratiques des principes FAIR
<br />
...
15 leviers, les étudiants se mettent par deux pour passer en revue un levier : 10 min puis restitution en 2 min par groupe
...
.footnote[Samuel Goeta (2016). *Instaurer des données, instaurer des publics : une enquête sociologique dans les coulisses de l'open data*. Thèse de doctorat, Télécom ParisTech https://pastel.archives-ouvertes.fr/tel-01458098]
...
Les laisser lire le texte et le debriefer à l'oral. Qu'en retenez-vous ? Qu'est-ce qui vous surprend ?
